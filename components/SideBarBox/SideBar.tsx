...
const SideBar = () => {
  return (
    <SideBarContainer>
      <Image src={img1} alt="image" height={30} width={30} />

      <Image src={img2} alt="image" height={30} width={30} />
      <Image src={img3} alt="image" height={30} width={30} />
      <Image src={img4} alt="image" height={30} width={30} />
    </SideBarContainer>
  );
};
